...
CREATE TABLE "building_stations" (
    ...
    CONSTRAINT "building_stations_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "units" (
    ...
    "exclusiveArea" DOUBLE PRECISION NOT NULL,
    "direction" TEXT,
...
CREATE TABLE "building_equipment" (
    ...
    CONSTRAINT "building_equipment_pkey" PRIMARY KEY ("buildingId","equipmentId")
);
...
CREATE TABLE "unit_equipment" (
    ...
    CONSTRAINT "unit_equipment_pkey" PRIMARY KEY ("unitId","equipmentId")
);
...
-- AddForeignKey
ALTER TABLE "building_stations" ADD CONSTRAINT "building_stations_buildingId_fkey" FOREIGN KEY ("buildingId") REFERENCES "buildings"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "other_costs" ADD CONSTRAINT "other_costs_unitId_fkey" FOREIGN KEY ("unitId") REFERENCES "units"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "photos" ADD CONSTRAINT "photos_buildingId_fkey" FOREIGN KEY ("buildingId") REFERENCES "buildings"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "building_equipment" ADD CONSTRAINT "building_equipment_buildingId_fkey" FOREIGN KEY ("buildingId") REFERENCES "buildings"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "building_equipment" ADD CONSTRAINT "building_equipment_equipmentId_fkey" FOREIGN KEY ("equipmentId") REFERENCES "equipment_master"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "unit_equipment" ADD CONSTRAINT "unit_equipment_equipmentId_fkey" FOREIGN KEY ("equipmentId") REFERENCES "equipment_master"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "inquiries" ADD CONSTRAINT "inquiries_unitId_fkey" FOREIGN KEY ("unitId") REFERENCES "units"("id") ON DELETE SET NULL ON UPDATE CASCADE;
